...
def model_input():
    ...
    KEY = "XC51313 - Abert's Towhee - Melozone aberti dumeticola.mp3" # replace with your object key

    s3 = boto3.resource('s3')

    try:
        s3.Bucket(BUCKET_NAME).download_file(KEY, "XC51313 - Abert's Towhee - Melozone aberti dumeticola.mp3")
    ...
    wave_data, wave_rate = librosa.load("XC550527 - Abert's Towhee - Melozone aberti.mp3")
    ...
    data_df = pd.DataFrame([{'bird': "sample bird", 'song_sample': "C:/Users/Andy/Desktop/Final_Project/upload_mel/3fccc0d0-63b2-49e6-9a33-c98257ca6386.tif"}])
    ...
    bird_list = pd.read_csv('xeno-canto_ca-nv_index.csv')
